...
def main(
        input_path, dilation_pixels, feather_amount, face_classes, exclude_classes, include_classes, add_original_mask, threshold,
    ...
    for i, face_data in enumerate(face_gender_data):
        ...
        face_mask, segmentation_success, nonzero_pixels, box_pixels, image_pixels, percentage = segment_face(
            bisenet_model, image, face_image, new_bounding_box, dilation_pixels, feather_amount, face_classes, exclude_classes, include_classes, add_original_mask, threshold,
            dilation_pixels_B, dilation_pixels_C, feather_amount_B, feather_amount_C, add_original_mask_B, add_original_mask_C
        )
